	...
	<div class="women-product">
		...
		<div class="grid-product">
		  <div class="  product-grid">
			<div class="content_box"><a href="Eavan Women's Shift Dress.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/ea746-eavan-s-400x400-imaefxkwj2ra8vks.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				</div>
				    <h4><a href="Eavan Women's Shift Dress.php"> Eavan Women's Shift Dress</a></h4>
				     <p></p>
				     Rs. 1439
			   	</div>
              </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="Elle Skinny Fit Women's Jeans.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/eejn0032blue-elle-28-400x400-imaefgc5hpt2zjfm.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="Elle Skinny Fit Women's Jeans.php"> Elle Skinny Fit Women's Jeans</a></h4>
				     <p></p>
				     Rs. 2699
			   	</div>
                 </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="Janasya Self Design Fashion Chiffon Sari.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/jne0182-janasya-400x400-imae22eyy4kyvhfu.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="Janasya Self Design Fashion Chiffon Sari.php"> Janasya Self Design Fashion Chiffon Sari</a></h4>
				     <p></p>
				     Rs. 1999
			   	</div>
                 </div>
		  <div class="  product-grid">
			<div class="content_box"><a href="Khantil Net Printed Semi-stitched Salwar Suit Dupatta Material.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/dss1095-1448-white-khantil-400x400-imaefg4gah3rrqa6.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="Khantil Net Printed Semi-stitched Salwar Suit Dupatta Material.php"> Khantil Net Printed Semi-stitched Salwar Suit Dupatta Material</a></h4>
				     <p></p>
				     Rs. 899
			   	</div>
              </div>
			...
			$(function() {
			    ...
			    menu_a.click(function(e) {
					...
					<div class=" chain-grid menu-chain">
	   		     	 ...
	   		     	 <a class="view-all all-product" href="product.php"></a> 	
			</div>-->
	<div class="clearfix"> </div>
</div>
	<!---->
