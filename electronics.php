	...
	<div class="women-product">
		...
		<div class="grid-product">
		  <div class="  product-grid">
			<div class="content_box"><a href="cameras.php">
			   	<div class="left-grid-view grid-view-left">
			   	  <img src="images/canon-powershot-sx520-hs-point-shoot-400x400-imaefxgzd2ufrh8wcopy.jpeg" height="273px" width="400px" class="img-responsive watch-right" alt=""/>
	   	  <div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				</div>
		      <h4><a href="cameras.php"> Cameras</a></h4>
				     <p></p>
				     
			   	</div>
              </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="mobiles.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/apple-iphone-5s-400x400-imadpppc9k3gzdjz.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="mobiles.php"> Mobiles</a></h4>
				     <p></p>
				     
			   	</div>
                 </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="laptops.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/asus-eeebook-netbook-x205ta-400x400-imae3uhssxqb3rdm.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="laptops.php"> Laptops</a></h4>
				     <p></p>
