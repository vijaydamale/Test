	...
	<div class="women-product">
		...
		<div class="grid-product">
		  <div class="  product-grid">
			<div class="content_box"><a href="gaming.php">
			   	<div class="left-grid-view grid-view-left">
			   	  <img src="images/indexs.jpg" height="273px" width="400px" class="img-responsive watch-right" alt=""/>
	   	  <div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				</div>
		      <h4><a href="gaming.php"> Books and media</a></h4>
				     <p></p>
