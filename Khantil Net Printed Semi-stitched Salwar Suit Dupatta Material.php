						...
						<ul id="etalage">
							<li>
								<a href="optionallink.php">
									<img class="etalage_thumb_image" src="images/dss1095-1448-white-khantil-400x400-imaefg4gah3rrqa6.jpeg"class="img-responsive" />
									<img class="etalage_source_image" src="images/dss1095-1448-white-khantil-400x400-imaefg4gah3rrqa6.jpeg"
...
<!--
				  ...
				  <div class="desc1 span_3_of_2">
					...
					<h1 itemprop="name">Khantil Net Printed Semi-stitched Salwar Suit Dupatta Material

</h1>
					<h4>&nbsp;</h4>
			  <div class="cart-b">
					<div class="left-n ">Rs. 899 </div>
				     <!--<a class="now-get get-cart-in" href="Aaple.php">ADD TO CART</a> --></form>
              		<form action="cart.php" method="post">       
                    <input type="hidden" value="35" name="psid">
...
<strong>Specifications of Khantil Net Printed Semi-stitched Salwar Suit Dupatta Material (Unstitched)</strong><br>
