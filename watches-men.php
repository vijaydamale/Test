	...
	<div class="women-product">
		...
		<div class="grid-product">
		  <div class="  product-grid">
			<div class="content_box"><a href="Casio Enticer Analog Watch - For Men.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/a504-casio-400x400-imadzush5hhnypzx.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				</div>
				    <h4><a href="Casio Enticer Analog Watch - For Men.php">Casio Enticer Analog Watch - For Men</a></h4>
				     <p></p>
				     Rs. 4599
			   	</div>
              </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="GiordanoAnalogWatch-ForMen.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/60058-giordano-black-and-blue-400x400-imadq8t9jyhhvp9p.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="GiordanoAnalogWatch-ForMen.php"> GiordanoAnalogWatch-ForMen</a></h4>
				     <p></p>
				     Rs. 15599
			   	</div>
                 </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="Casio Fiber Collection Analog-Digital Watch - For Men.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/a802-casio-400x400-imadzb45vmda2jc8.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="Casio Fiber Collection Analog-Digital Watch - For Men.php"> 
Casio Fiber Collection Analog-Digital Watch - For Men
</a></h4>
				     <p></p>
				     Rs. 4599
			   	</div>
		  ...
		  <div class="  product-grid">
			<div class="content_box"><a href="Titan Analog Watch - For Men.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/ne9324km01j-titan-400x400-imadsvgjgfckzrwu.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="images/ne9324km01j-titan-400x400-imadsvgjgfckzrwu.jpeg"> Newport Slim Fit Men's Jeans</a></h4>
				     <p></p>
				     Rs. 3599
			   	</div>
              </div>
			<div class="  product-grid">
			<div class="content_box"><a href="Titan Analog Watchmen.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/9234wl01-titan-400x400-imad9gmh2zk2rzk7.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="Titan Analog Watchmen.php"> Titan Analog Watch </a></h4>
				     <p></p>
				     Rs. 599
			   	</div>
                 </div>
