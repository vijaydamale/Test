...
<html>
<head>
<title>Big shope A Ecommerce Category Flat Bootstarp Resposive Website Template | </title>
...
<body> 
	...
	<div class="sub-cate">
		...
		<li class="item1"><a href="#">Electronics<img class="arrow-img" src="images/arrow1.png" alt=""/> </a>
			<ul class="cute">
				<li class="subitem1"><a href="product.php">Mobiles</a></li>
				<li class="subitem2"><a href="product.php">Laptops</a></li>
				<li class="subitem3"><a href="product.php">Cameras </a></li>
                <li class="subitem3"><a href="product.php">Televisions </a></li>
			</ul>
		</li>
		<li class="item2"><a href="#">Men <img class="arrow-img " src="images/arrow1.png" alt=""/></a>
			<ul class="cute">
				<li class="subitem1"><a href="product.php">Footware </a></li>
				<li class="subitem2"><a href="product.php">Clothing</a></li>
		...
		<li class="item4"><a href="#">Babycare <img class="arrow-img img-left-arrow" src="images/arrow1.png" alt=""/></a>
			<ul class="cute">
				<li class="subitem1"><a href="product.php">Footware </a></li>
				<li class="subitem2"><a href="product.php">Clothing</a></li>
				<li class="subitem3"><a href="product.php">Watches</a></li>
			...
			<div class="container">
				<div class="footer-bottom-cate">
					...
					<ul>
						...
						<li ><a href="#">Kids</a></li>
						<li ><a href="#">Books and Media</a></li>
