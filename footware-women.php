	...
	<div class="women-product">
		...
		<div class="grid-product">
		  <div class="  product-grid">
			<div class="content_box"><a href="Charu-Diva Design Studio Heel.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/gold-cds245-charu-diva-design-studio-36-400x400-imadys57wedh76yz.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				</div>
				    <h4><a href="Charu-Diva Design Studio Heel.php"> Charu-Diva Design Studio Heel</a></h4>
				     <p></p>
				     Rs. 1599
			   	</div>
              </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="Plosh Heels footwear.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/pink-o119-plosh-36-400x400-imae2m8axdrfsqpw.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="Plosh Heels footwear.php"> Plosh Heels footwear</a></h4>
				     <p></p>
				     Rs. 1699
			   	</div>
                 </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="lovely chick wedges.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/pink-650d-lovely-chick-37-400x400-imae27swud5ymtmh.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="lovely chick wedges.php"> lovely chick wedges</a></h4>
				     <p></p>
				     Rs. 699
			   	</div>
                 </div>
