						...
						<ul id="etalage">
							<li>
								<a href="optionallink.php">
									<img class="etalage_thumb_image" src="images/jne0182-janasya-400x400-imae22eyy4kyvhfu.jpeg"class="img-responsive" />
									<img class="etalage_source_image" src="images/jne0182-janasya-400x400-imae22eyy4kyvhfu.jpeg"
...
<!--
				  ...
				  <div class="desc1 span_3_of_2">
					...
					<h1 itemprop="name">Janasya Self Design Fashion Chiffon Sari

</h1>
					<h4>&nbsp;</h4>
			  <div class="cart-b">
					<div class="left-n ">Rs.  1,999 </div>
				     <!--<a class="now-get get-cart-in" href="Aaple.php">ADD TO CART</a> --></form>
              		<form action="cart.php" method="post">       
                    <input type="hidden" value="34" name="psid">
...
<strong>Key Features of Janasya Self Design Fashion Chiffon Sari</strong><br>
