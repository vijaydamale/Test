	...
	<div class="women-product">
		...
		<div class="grid-product">
		  <div class="  product-grid">
			<div class="content_box"><a href="clothing-men.php">
			   	<div class="left-grid-view grid-view-left">
			   	  <img src="images/14a4jm9555w8g06u-united-colors-of-benetton-32-400x400-imaefct3hghkfwfn.jpeg" height="273px" width="400px" class="img-responsive watch-right" alt=""/>
	   	  <div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				</div>
		      <h4><a href="clothing-men.php"> Clothing</a></h4>
				     <p></p>
				     
			   	</div>
              </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="footware-men.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/14a4jm9555w8g06u-united-colors-of-benetton-32-400x400-imaefct37gzhyzwj.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="footware-men.php"> Footware</a></h4>
				     <p></p>
				     
			   	</div>
                 </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="watches-men.php">
			   	<div class="left-grid-view grid-view-left">
				    ...
				    <h4><a href="watches-men.php"> Watches</a></h4>
				     <p></p>
				     
			   	</div>
                 </div>
		  <!--<div class="  product-grid">
			<div class="content_box"><a href="television.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/samsung-40h5500-400x400-imadvvzfgbd5r53z.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="television.php"> Television</a></h4>
				     <p></p>
	...
	<div class="sub-cate">
		...
		<script type="text/javascript">
			...
			<!--		<div class=" chain-grid menu-chain">
	   		     	 ...
	   		     	 <a class="view-all alproduct" href="product.php"></a> 	
			</div>
	<div class="clearfix"> </div>
</div>
	<!---->
