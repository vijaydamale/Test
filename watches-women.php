	...
	<div class="women-product">
		...
		<div class="grid-product">
		  <div class="  product-grid">
			<div class="content_box"><a href="Casio Sheen Analog Watch - For Women.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/sx099-casio-400x400-imae4bejs3jgtvqn.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				</div>
				    <h4><a href="Casio Sheen Analog Watch - For Women.php"> Casio Sheen Analog Watch - For Women</a></h4>
				     <p></p>
				     Rs. 7195
			   	</div>
              </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="Maxima Swarovski Gold Analog Watch - For Women.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/29411bmly-maxima-400x400-imadwq4g4hzhm2eh.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="Maxima Swarovski Gold Analog Watch - For Women.php"> Maxima Swarovski Gold Analog Watch - For Women</a></h4>
				     <p></p>
				     Rs. 1185
			   	</div>
                 </div>
			 <div class="  product-grid">
			<div class="content_box"><a href="Titan Raga Analog Watch - For Women.php">
			   	<div class="left-grid-view grid-view-left">
			   	   	 <img src="images/9907ym01-titan-400x400-imae4dftx82yfzxs.jpeg" class="img-responsive watch-right" alt=""/>
				   	   	<div class="mask">
	                        <div class="info">Quick View</div>
			            </div>
				   	  </a>
				   </div>
				    <h4><a href="Titan Raga Analog Watch - For Women.php"> Titan Raga Analog Watch - For Women</a></h4>
				     <p></p>
				     Rs. 3499
			   	</div>
                 </div>
